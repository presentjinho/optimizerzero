...
importScripts("./vendor/jszip.min.js?v25", "./vendor/pdf-lib.min.js?v25", "./vendor/pdfjs/pdf.min.js?v25");
...
// for the duration of the import.
{
  ...
  self.postMessage = () => {};
  importScripts("./vendor/pdfjs/pdf.worker.min.js?v25");
  self.postMessage = realPostMessage;
}

importScripts("./optimize-core.js?v25");
