...
importScripts("./vendor/jszip.min.js?v24", "./vendor/pdf-lib.min.js?v24", "./vendor/pdfjs/pdf.min.js?v24");
...
// for the duration of the import.
{
  ...
  self.postMessage = () => {};
  importScripts("./vendor/pdfjs/pdf.worker.min.js?v24");
  self.postMessage = realPostMessage;
}

importScripts("./optimize-core.js?v24");
