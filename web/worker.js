...
importScripts("./vendor/jszip.min.js?v22", "./vendor/pdf-lib.min.js?v22", "./vendor/pdfjs/pdf.min.js?v22");
...
// for the duration of the import.
{
  ...
  self.postMessage = () => {};
  importScripts("./vendor/pdfjs/pdf.worker.min.js?v22");
  self.postMessage = realPostMessage;
}

importScripts("./optimize-core.js?v22");
